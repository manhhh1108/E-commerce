    ...
    return _auth.currentUser == null
      ...
      builder: (BuildContext context,
        ...
        if (!snapshot.hasData || !snapshot.data!.exists) {
          // Nếu không có dữ liệu hoặc không phải buyer hợp lệ, hiển thị màn hình giống chưa đăng nhập
          return Scaffold(
            appBar: AppBar(
              automaticallyImplyLeading: false,
              iconTheme: IconThemeData(color: Colors.white),
        ...
        // Kiểm tra nếu buyerId và uid của người dùng trùng nhau
        if (data['buyerId'] != _auth.currentUser!.uid) {
          // Nếu không trùng khớp, hiển thị màn hình giống như chưa đăng nhập
          return Scaffold(
            appBar: AppBar(
              automaticallyImplyLeading: false,
              iconTheme: IconThemeData(color: Colors.white),
